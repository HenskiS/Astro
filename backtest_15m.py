"""
BACKTEST 15-MINUTE BREAKOUT STRATEGY
=====================================
Ultra high-frequency adaptation with:
- Emergency: 48 periods (12 hours) vs 96h for 1h
- Trailing: 0.0015 trigger (0.15%), 65% trail
- Ladders: [0.003, 0.006] (0.3%, 0.6%)
...
print("="*100)
print("BACKTEST: 15-MINUTE BREAKOUT STRATEGY (WITH SPREAD COSTS)")
print("="*100)
print()
...
# Strategy Parameters (adapted for 15m timeframe)
INITIAL_CAPITAL = 500
RISK_PER_TRADE = 0.004  # 0.4%
MIN_CONFIDENCE = 0.65

# Emergency stop: 48 periods = 12 hours (vs 96h for 1h)
EMERGENCY_STOP_PERIODS = 48
EMERGENCY_STOP_LOSS_PCT = -0.04

# Trailing stop (adjusted for 15m volatility)
TRAILING_STOP_TRIGGER = 0.0015  # 0.15% (vs 0.2% for 1h)
TRAILING_STOP_PCT = 0.65  # 65%

# Ladder parameters (smaller moves for 15m)
LADDER_LEVELS = [0.003, 0.006]  # 0.3%, 0.6% (vs 0.4%, 0.8% for 1h)
...
print("="*100)
print()
print("1H Strategy (8 pairs, ~3 months, WITH spread costs):")
print("  CAGR: 113.4%")
print("  Max DD: -0.8%")
print("  Win Rate: 89.3%")
print("  Avg Hold: 2.9 days winners, 4.2 days losers")
print()
print(f"15M Strategy (4 pairs, {years:.1f} years) WITH SPREAD COSTS:")
print(f"  CAGR: {cagr:.1%}")
...
print("  - 15M has 4x more opportunities per hour")
print("  - Spread costs are proportionally HIGHER for 15M")
print("  - 15M requires tighter risk management")
print("  - Hold times much shorter (hours vs days)")
print()

# Save results
print("Saving results...")
trades_df.to_csv('backtest_15m_results.csv', index=False)
print("Results saved to: backtest_15m_results.csv")
print()
