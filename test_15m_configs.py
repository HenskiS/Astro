"""
TEST 3 KEY 15M CONFIGURATIONS
==============================
Much faster - test only 3 promising parameter sets based on:
1. Current issue: losers hold 198.9 hours (8.3 days) - way too long
2. Need MUCH shorter emergency stops
...
print("="*100)
print("TESTING 3 KEY 15M CONFIGURATIONS")
print("="*100)
print()
...
# Test variations of the VERY TIGHT style
CONFIGS = [
    {
        'name': 'ULTRA TIGHT (4.5h emergency)',
        'emergency_periods': 18,  # 4.5 hours
        'trailing_trigger': 0.0008,  # 0.08%
        'trailing_pct': 0.70,
        'confidence': 0.70,
        'ladders': [0.002, 0.004]
    },
    {
        'name': 'VERY TIGHT (6h emergency) - ORIGINAL',
        'emergency_periods': 24,  # 6 hours
        'trailing_trigger': 0.001,  # 0.1%
        'trailing_pct': 0.70,
        'confidence': 0.70,
        'ladders': [0.002, 0.004]
    },
    {
        'name': 'TIGHT + Higher Confidence',
        'emergency_periods': 24,  # 6 hours
        'trailing_trigger': 0.001,  # 0.1%
        'trailing_pct': 0.70,
        'confidence': 0.75,  # More selective
        'ladders': [0.002, 0.004]
    },
    {
        ...
        'emergency_periods': 24,  # 6 hours
        'trailing_trigger': 0.001,  # 0.1%
        'trailing_pct': 0.75,  # Trail closer
        'confidence': 0.70,
        'ladders': [0.002, 0.004]
    },
    {
        'name': 'TIGHT + Smaller Ladders',
        'emergency_periods': 24,  # 6 hours
        'trailing_trigger': 0.001,  # 0.1%
        'trailing_pct': 0.70,
        'confidence': 0.70,
        'ladders': [0.0015, 0.003]  # Tighter profit taking
    },
    {
        'name': 'TIGHT + 7.5h Emergency',
        'emergency_periods': 30,  # 7.5 hours
        'trailing_trigger': 0.001,  # 0.1%
        'trailing_pct': 0.70,
        'confidence': 0.70,
        'ladders': [0.002, 0.004]
