"""
GENERATE PREDICTIONS - QUARTERLY RETRAINING
============================================
Train models with quarterly retraining (every 3 months).

Note: Quarterly periods from 2016-2025 (40 quarters total)
Train on last 6 years, test on next quarter
...
print("="*100)
print("GENERATING MODEL PREDICTIONS - QUARTERLY RETRAINING")
print("="*100)
print()
...
for period in TEST_PERIODS:
    ...
    print(f"[{quarters_processed}/{len(TEST_PERIODS)}] Processing {period['name']}...")
...
# Save predictions
output_file = 'model_predictions_quarterly.pkl'
with open(output_file, 'wb') as f:
    pickle.dump(all_predictions, f)

print("="*100)
print(f"Quarterly predictions saved to {output_file}")
print()
print("Total predictions by quarter:")
