"""
WALK-FORWARD ANALYSIS FOR 15M STRATEGY (9-MONTH WINDOW)
========================================================
Simulates production retraining by:
1. Train on 9 months of data (vs 6 months in original)
2. Test on next 1 month
3. Slide window forward and repeat
4. Aggregate all test results

Tests if longer training window (50% more data) improves performance.
"""
import pandas as pd
import numpy as np
...
print("="*100)
print("WALK-FORWARD ANALYSIS: 15M BREAKOUT STRATEGY (9-MONTH WINDOW)")
print("="*100)
print()

# Walk-forward parameters
TRAIN_MONTHS = 9  # Train on 9 months (50% more than 6)
...
print("="*100)
print()
print("9-MONTH WINDOW walk-forward analysis:")
print(f"  - Train on {TRAIN_MONTHS} months of data (50% more than 6-month)")
print(f"  - Test on next {TEST_MONTHS} month")
print(f"  - Retrain and slide forward")
print()
print("This tests if longer training window improves performance:")
print("  - More training data = potentially better model")
print("  - Still uses only past data (no lookahead)")
print("  - Trades off: more data vs more recent data")
print()
...
print(f"  9-month fixed window: {total_return:+.1%} return, {cagr:.1%} CAGR")
print()
print("Key question: Does 50% more training data (9 vs 6 months) improve performance?")
print("  - More data could capture more market patterns")
print("  - But older data may be less relevant for current markets")
print("  - Trade-off between data quantity and recency")
print()
