"""
WALK-FORWARD ANALYSIS FOR 15M STRATEGY
=======================================
...
This is the most realistic performance estimate for production.
"""
import pandas as pd
import numpy as np
...
print("="*100)
print("WALK-FORWARD ANALYSIS: 15M BREAKOUT STRATEGY")
print("="*100)
print()
...
print("="*100)
print()
print("Walk-forward analysis simulates production retraining:")
print(f"  - Train on {TRAIN_MONTHS} months of data")
print(f"  - Test on next {TEST_MONTHS} month")
print(f"  - Retrain and slide forward")
print()
print("This provides the most realistic performance estimate because:")
print("  - Models are retrained with only past data")
print("  - No lookahead bias")
print("  - Simulates production retraining schedule")
print()
print("Compare with single-train backtest (backtest_15m_optimized.py):")
print("  Single-train: +49.6% return, 202% CAGR (on same test period)")
print(f"  Walk-forward: {total_return:+.1%} return, {cagr:.1%} CAGR")
print()
print("Walk-forward typically shows lower performance because:")
print("  - Models trained on less data in early windows")
print("  - Models don't benefit from seeing the entire training period")
